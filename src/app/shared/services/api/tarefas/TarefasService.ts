...
const getAll = async (): Promise<ITarefa[] | ApiException> => {
  try {
    ...
    return new ApiException(error.message || "Erro ao buscar os registro Api.");
  }
};
...
const updateById = async (
  ...
  try {
    ...
    return new ApiException(
      error.message || "Erro ao atualizar o registro na Api."
    );
  }
};
...
const deleteById = async (id: number): Promise<undefined | ApiException> => {
  try {
    ...
    return new ApiException(
      error.message || "Erro ao apagar o registro na Api."
    );
  }
};
